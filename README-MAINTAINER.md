...
> @xpack/tsdoc2docusaurus-cli@1.3.0 fix
...
Determine the next version (like `1.3.0`),
and eventually update the
`package.json` file; the format is `1.3.0-pre`.
...
- add a line _* v1.3.0 released_
- commit with a message like _prepare v1.3.0_
...
- `npm dist-tag add @xpack/tsdoc2docusaurus-cli@1.3.0 latest`
- `npm dist-tag ls @xpack/tsdoc2docusaurus-cli`
